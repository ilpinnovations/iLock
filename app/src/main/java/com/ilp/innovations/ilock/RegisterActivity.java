...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !serverAddr.isEmpty() && !lockId.isEmpty()) {
                    ...
                    if(!serverAddr.matches(ipExprn))
                        ...
                        registerUser(serverAddr, lockId, name, email, password);
                } else {
     ...
     * */
    private void registerUser(final String serverAddr, final String lockId, final String name, final String email,
        ...
        protected void onPostExecute(String response) {
            try {
                ...
                if (!error) {
                    ...
                    String lockId = user.getString("lockId");
                    String created_at = user
                            .getString("created_at");

                    // Inserting row in users table
                    db.addUser(userData.get("server"), lockId, name, email, uid, created_at);
                    hideDialog();
